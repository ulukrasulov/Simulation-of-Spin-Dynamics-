...
omega_Z=2*pi*1000; %Zeeman Frequency 
omega_X=0*pi*1000; %Magnetic Field in X Control frequency
omega_Y=0*pi*1000; %Magnetic Field in Y Control frequency

H_0=-omega_Z*sigma_z; %“drift” part of the Hamiltonian that cannot be controlled

H=H_0 + omega_X*sigma_x + omega_Y*sigma_y; %Drift Hamiltonian plus magnatic controls
